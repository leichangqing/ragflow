...
# NOTE: libssl1.1 is deprecated and not available in Ubuntu 24.04
# If aspose-slides fails, need to switch to OpenSSL 3-compatible version or .NET Core libssl shim.
# RUN dpkg -i /deps/libssl1.1_xxx.deb
